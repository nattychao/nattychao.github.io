...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
    <div class="mb-12">
      <h1 class="text-4xl font-bold text-slate-900 mb-4">所有项目</h1>
      <p class="text-slate-600">我开发的一些项目作品。</p>
    </div>
      ...
      <div v-for="project in projects" :key="project.title" class="group">
        <div class="relative overflow-hidden rounded-2xl mb-4 aspect-video">
          ...
          <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
            <span 
              class="text-white font-semibold border border-white/30 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full cursor-pointer hover:bg-white/20 transition-colors"
