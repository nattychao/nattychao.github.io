    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex overflow-x-auto gap-3 pb-4 hide-scrollbar md:hidden -mx-4 px-2">
        <router-link v-for="(post, index) in allRecentPosts" :key="post.slug" :to="`/blog/${post.slug}`"
          class="group bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 flex-shrink-0 w-[80vw] mx-1">
