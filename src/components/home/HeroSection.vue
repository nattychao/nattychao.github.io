...
// 背景图片 - 只保留第二张图片
const heroBgImage = 'https://images.unsplash.com/photo-1727434032773-af3cd98375ba?q=80&w=3864&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D%3D&auto=format&fit=crop&w=2070&q=80'
</script>
    ...
    <div class="px-4 sm:px-6 lg:px-8 relative z-10 w-full max-w-7xl mx-auto">
      <div class="text-center">
        ...
        <p
          ...
          你好,我是 <span
            class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300 animate-gradient">Nattychao</span>。我致力于打造美观、实用且以用户为中心的
          Web 体验,解决真实世界的问题。
        </p>
        <div class="flex flex-row justify-center gap-2 sm:gap-3 md:gap-5 px-4">
          <router-link to="/resume"
            class="px-4 sm:px-5 md:px-8 py-2 sm:py-3 md:py-4 bg-white text-indigo-900 rounded-full font-bold hover:bg-slate-100 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 flex items-center justify-center gap-2 text-xs sm:text-sm md:text-base whitespace-nowrap">
            查看简历
