  ...
  >
    ...
    >
      ...
      <div class="relative overflow-hidden bg-gradient-to-r from-indigo-500 to-purple-600 p-4 sm:p-6 shadow-lg">
        <!-- 装饰性背景元素 - 添加无规则运动的半圆 -->
        <div class="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-white/10 rounded-full -mr-12 -mt-12 sm:-mr-16 sm:-mt-16 floating-irregular-1"></div>
        <div class="absolute bottom-0 left-0 w-20 h-20 sm:w-24 sm:h-24 bg-white/10 rounded-full -ml-10 -mb-10 sm:-ml-12 sm:-mb-12 floating-irregular-2"></div>
      ...
      <div class="py-4 sm:py-6">
        ...
        <div class="space-y-1 px-2">
          <RouterLink 
            ...
            @click="closeMenu"
          >
            <span class="w-7 h-7 sm:w-8 sm:h-8 mr-2 sm:mr-3 flex items-center justify-center rounded-lg transition-all duration-200"
              :class="isActiveLink(link.path) 
      ...
      <div class="mt-auto border-t border-slate-100 bg-gradient-to-r from-slate-50 to-white p-4 sm:p-6">
        ...
        <div class="grid grid-cols-2 gap-2 sm:gap-3">
          <a 
            href="https://github.com/nattychao" 
            target="_blank"
          ...
          >
            <!-- 背景装饰 -->
            <div class="absolute inset-0 bg-gradient-to-br from-indigo-500/5 to-purple-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            
            <!-- 图标容器 -->
            <div class="relative w-10 h-10 sm:w-12 sm:h-12 mb-1.5 sm:mb-2 flex items-center justify-center rounded-lg sm:rounded-xl bg-gradient-to-br from-slate-100 to-slate-50 group-hover:from-indigo-100 group-hover:to-purple-100 transition-all duration-300 shadow-sm group-hover:shadow-md">
              <Github class="w-5 h-5 sm:w-6 sm:h-6 text-slate-600 group-hover:text-indigo-600 transition-colors" />
            </div>
            
            <!-- 文字内容 -->
            <div class="text-center relative z-10">
              <div class="text-xs sm:text-sm font-medium text-slate-900 group-hover:text-indigo-700 transition-colors">GitHub</div>
              <div class="text-xs text-slate-500 group-hover:text-indigo-500 transition-colors mt-0.5">查看项目</div>
            </div>
          </a>
          <a 
            href="mailto:2439194386@qq.com"
            class="group relative flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-br from-slate-50 to-white shadow-sm border border-slate-100 hover:shadow-lg hover:border-indigo-200 transition-all duration-300 overflow-hidden"
          >
            <!-- 背景装饰 -->
            <div class="absolute inset-0 bg-gradient-to-br from-indigo-500/5 to-purple-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            ...
            <!-- 文字内容 -->
            <div class="text-center relative z-10">
              <div class="text-xs sm:text-sm font-medium text-slate-900 group-hover:text-indigo-700 transition-colors">邮件</div>
              <div class="text-xs text-slate-500 group-hover:text-indigo-500 transition-colors mt-0.5">发送邮件</div>
            </div>
          </a>
          <a 
            href="tel:+8617681870768"
            class="group relative flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-br from-slate-50 to-white shadow-sm border border-slate-100 hover:shadow-lg hover:border-indigo-200 transition-all duration-300 overflow-hidden"
          >
            <!-- 背景装饰 -->
            <div class="absolute inset-0 bg-gradient-to-br from-indigo-500/5 to-purple-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            ...
            <!-- 文字内容 -->
            <div class="text-center relative z-10">
              <div class="text-xs sm:text-sm font-medium text-slate-900 group-hover:text-indigo-700 transition-colors">电话</div>
          ...
          >
            ...
            <!-- 图标容器 -->
            <div class="relative w-10 h-10 sm:w-12 sm:h-12 mb-1.5 sm:mb-2 flex items-center justify-center rounded-lg sm:rounded-xl bg-gradient-to-br from-slate-100 to-slate-50 group-hover:from-indigo-100 group-hover:to-purple-100 transition-all duration-300 shadow-sm group-hover:shadow-md">
              <MessageCircle class="w-5 h-5 sm:w-6 sm:h-6 text-slate-600 group-hover:text-indigo-600 transition-colors" />
            </div>
            
            <!-- 文字内容 -->
            <div class="text-center relative z-10">
              <div class="text-xs sm:text-sm font-medium text-slate-900 group-hover:text-indigo-700 transition-colors">微信</div>
