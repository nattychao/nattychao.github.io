        ...
        <div class="text-center md:text-left">
          ...
          <ul class="space-y-2 sm:space-y-3 text-sm sm:text-base text-slate-600">
            ...
            <li class="flex items-center justify-center md:justify-start gap-2 group cursor-pointer" @click="copyWeChat">
              ...
              <span class="hover:text-green-600 transition-colors relative inline-block after:content-[''] after:absolute after:w-0 after:h-[1px] after:bottom-0 after:left-0 after:bg-green-600 after:transition-all after:duration-300 hover:after:w-full cursor-pointer">WeChat: nattychao</span>
            </li>
            <li class="flex items-center justify-center md:justify-start gap-2 group">
              ...
              <a href="mailto:nattychaoo@gmail.com" class="hover:text-red-600 transition-colors relative inline-block after:content-[''] after:absolute after:w-0 after:h-[1px] after:bottom-0 after:left-0 after:bg-red-600 after:transition-all after:duration-300 hover:after:w-full">nattychaoo@gmail.com</a>
            </li>
          </ul>
        </div>
        ...
        <div class="text-center md:text-left">
          ...
          <div class="flex justify-center md:justify-start gap-3 sm:gap-4">
            ...
            <div @click="copyWeChatFromSocial" class="group cursor-pointer">
              <div class="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 group-hover:bg-green-500 group-hover:text-white transition-all duration-300 transform group-hover:scale-110">
