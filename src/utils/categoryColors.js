...
export const categoryColors = {
  // 编程语言颜色参考GitHub语言色彩
  'Objective-C': 'bg-blue-100 text-blue-800 border-blue-200', // GitHub: #438eff
  ...
  'Solid': 'bg-indigo-100 text-indigo-800 border-indigo-200', // Solid蓝色
  'AFNetworking': 'bg-blue-100 text-blue-800 border-blue-200', // 与Objective-C相同
  ...
  'TypeScript': 'bg-blue-100 text-blue-800 border-blue-200', // TypeScript蓝色
  ...
  '布局': 'bg-indigo-100 text-indigo-800 border-indigo-200', // 布局相关
  'Web': 'bg-blue-100 text-blue-800 border-blue-200', // Web相关
  'Jest': 'bg-red-100 text-red-800 border-red-200', // Jest红色
  'Cypress': 'bg-teal-100 text-teal-800 border-teal-200', // Cypress绿色
  
  // GitHub上其他主流语言标签
  'Python': 'bg-blue-100 text-blue-800 border-blue-200', // GitHub: #3572A5
  ...
  'C++': 'bg-blue-100 text-blue-800 border-blue-200', // GitHub: #f34b7d
  'C#': 'bg-purple-100 text-purple-800 border-purple-200', // GitHub: #239120
  'PHP': 'bg-indigo-100 text-indigo-800 border-indigo-200', // GitHub: #4F5D95
  ...
  'Dart': 'bg-blue-100 text-blue-800 border-blue-200', // GitHub: #00B4AB
